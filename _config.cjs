module.exports = {
  ...
  meta: {
    ...
    keywords: `three, threejs, three-js, webgl, 3D, GLSL, GLSL shaders, shaders, web3D javascript, js, vanilla-javascript, vanilla-js, development, template, boilerplate, template-boilerplate, boilerplate-frontend, starter-kit, webpack, babel, core-js, husky, eslint, commitlint, prettier, postcss, tailwind, tailwindcss, sass, scss, css, github, web app, web-app, webapp, spa 
    `
  }
};
